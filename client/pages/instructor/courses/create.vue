                                                ...
                                                <div v-if="form.free_course == false">
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-lg-10">
                                                            ...
                                                            <small class="text-muted">This course has <span id="discounted_percentage" class="text-danger">99.00%</span> Discount</small>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async save() {
                try {
                    const { data } = await this.form.post('/instructor/courses/create')
                    .then((res) => {
