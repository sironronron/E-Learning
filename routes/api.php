...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::prefix('student/account/my-courses')->group(function () {
        ...
        Route::get('/learning/{slug}/show', 'User\UserCoursesController@showCourseLessons');
...
Route::group(['middleware' => 'auth:api'], function () {
    Route::prefix('instructor')->group(function () {
        ...
        Route::post('/courses/section/add_quiz/post/{id}', 'Instructor\Courses\CourseSectionQuizController@store');
